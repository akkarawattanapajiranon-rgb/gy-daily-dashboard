...
function testFixedCombinedWaste(monthFolder, dayNum) {
  ...
  console.log(`\nFixed Results for [${monthFolder}] Day ${dayNum}:`);
  console.log('  Totals:', {
...
testFixedCombinedWaste('4. APRIL 2026', 1);
testFixedCombinedWaste('4. APRIL 2026', 3);
testFixedCombinedWaste('5. MAY 2026', 3);
